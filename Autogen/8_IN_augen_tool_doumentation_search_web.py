# This script demonstrates how to use Playwright to search DuckDuckGo for a query, 
# extract the first result link, and then scrape the content from that link. 
# It also includes an example of how to use the autogen library to create an agent that can perform these tasks.
